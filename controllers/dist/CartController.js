...
var CartController = /** @class */ (function () {
    ...
    CartController.prototype.get = function (request, response) {
    ...
    CartController.prototype.getAll = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    CartController.prototype.getById = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    CartController.prototype.deleteProductCart = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        _id = request.params.id;
                        return [4 /*yield*/, this._service.deleteProductCart(_id)];
                    case 1:
                        result = _a.sent();
                        response.status(200).json({ result: result });
                        return [3 /*break*/, 3];
    ...
    CartController.prototype.registerProductCart = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var user_id, quantity, product_id, product, unit_price, total_price, order_id, status, result, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        return [4 /*yield*/, this._service.registerProductCart(user_id, quantity, product_id, product, unit_price, total_price, order_id, status)];
                    case 1:
                        result = _a.sent();
                        response.status(200).json({ result: result });
                        return [3 /*break*/, 3];
    ...
    CartController.prototype.updateProductCart = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, user_id, quantity, product_id, product, unit_price, total_price, status, result, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        total_price = request.params.total_price;
                        status = request.params.status;
                        return [4 /*yield*/, this._service.updateProductCart(id, user_id, quantity, product_id, product, unit_price, total_price, status)];
                    case 1:
                        result = _a.sent();
                        response.status(200).json({ result: result });
                        return [3 /*break*/, 3];

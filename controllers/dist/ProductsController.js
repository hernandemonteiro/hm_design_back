...
var ProductsController = /** @class */ (function () {
    ...
    ProductsController.prototype.get = function (request, response) {
    ...
    ProductsController.prototype.getAll = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ProductsController.prototype.getById = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._service.deleteProduct(id)];
                    case 1:
                        result = _a.sent();
                        response.status(200).json({ result: result });
                        return [3 /*break*/, 3];
    ...
    ProductsController.prototype.registerProduct = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var name, price, description, category, images, status, options, result, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        status = request.params.name;
                        options = request.params.name;
                        return [4 /*yield*/, this._service.registerProduct(name, price, description, category, images, status, options)];
                    case 1:
                        result = _a.sent();
                        response.status(200).json({ result: result });
                        return [3 /*break*/, 3];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._service.updateProduct(id, name, price, description, images, status, options)];
                    case 1:
                        result = _a.sent();
                        response.status(200).json({ result: result });
                        return [3 /*break*/, 3];
